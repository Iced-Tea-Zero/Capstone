function showNewButton() {
  ...
  if (buttonId === "show-btn-1") {
    ...
    buttonText = "디자인 트렌드";
    hashtag = "디자인 트렌드";
  } else if (buttonId === "show-btn-42") {
    buttonText = "의상";
    hashtag = "의상";
  } else if (buttonId === "show-btn-43") {
    buttonText = "굿즈";
    hashtag = "굿즈";
  } else if (buttonId === "show-btn-44") {
    buttonText = "상품";
    hashtag = "상품";
  } else if (buttonId === "show-btn-45") {
    buttonText = "움짤";
    hashtag = "움짤";
  } else if (buttonId === "show-btn-46") {
    buttonText = "자막";
    hashtag = "자막";
  } else if (buttonId === "show-btn-47") {
    buttonText = "AI";
    hashtag = "AI";
  } else if (buttonId === "show-btn-48") {
    buttonText = "다운로드";
    hashtag = "다운로드";
  } else if (buttonId === "show-btn-49") {
    buttonText = "인쇄물";
    hashtag = "인쇄물";
  } else if (buttonId === "show-btn-50") {
    buttonText = "모자이크";
    hashtag = "모자이크";
  } else if (buttonId === "show-btn-51") {
    buttonText = "크로마키";
    hashtag = "크로마키";
  } else if (buttonId === "show-btn-52") {
    buttonText = "사진";
    hashtag = "사진";
  } else if (buttonId === "show-btn-53") {
    buttonText = "UI";
    hashtag = "UI";
  }
...
document.getElementById("show-btn-41").addEventListener("click", showNewButton);
document.getElementById("show-btn-42").addEventListener("click", showNewButton);
document.getElementById("show-btn-43").addEventListener("click", showNewButton);
document.getElementById("show-btn-44").addEventListener("click", showNewButton);
document.getElementById("show-btn-45").addEventListener("click", showNewButton);
document.getElementById("show-btn-46").addEventListener("click", showNewButton);
document.getElementById("show-btn-47").addEventListener("click", showNewButton);
document.getElementById("show-btn-48").addEventListener("click", showNewButton);
document.getElementById("show-btn-49").addEventListener("click", showNewButton);
document.getElementById("show-btn-50").addEventListener("click", showNewButton);
document.getElementById("show-btn-51").addEventListener("click", showNewButton);
document.getElementById("show-btn-52").addEventListener("click", showNewButton);
document.getElementById("show-btn-53").addEventListener("click", showNewButton);
